...
<div class="not-content" style="margin: 2rem 0; text-align: center;">
  <img src="/dashboard/demo-dashboard.gif" alt="Banyan CLI dashboard — live cluster monitoring in your terminal" style="max-width: 100%; border-radius: 8px; border: 1px solid var(--sl-color-gray-5); box-shadow: 0 4px 24px rgba(0, 0, 0, 0.12);" />
