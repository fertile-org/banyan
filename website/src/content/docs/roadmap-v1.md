---
title: Roadmap v1 (Archive)
description: Original milestone-by-milestone roadmap — M1 through M16.
sidebar:
  order: 100
  hidden: true
---

> This is the original Banyan roadmap, preserved for reference. For the current roadmap, see [Roadmap](/roadmap/).
